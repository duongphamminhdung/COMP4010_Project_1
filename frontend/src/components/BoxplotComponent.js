...
const COLOR_A = "#4da8da";
const COLOR_B = "#c9799a";
const COLOR_A_LINE = "#2e86bb";
const COLOR_B_LINE = "#a85478";
...
function BoxplotComponent({
  ...
  return (
    <div>
      <h3 className="page3-section-title">Distribution Comparison (Boxplot)</h3>
      ...
      <Plot
        ...
        layout={{
          title: {
            text: `<b>${featureLabel}</b> — distribution per group`,
            font: { color: PLOTLY_TEXT, size: 16 },
            x: 0.5,
            xanchor: "center",
          },
          autosize: true,
          margin: { l: 96, r: 230, t: 56, b: 96 },
          paper_bgcolor: PLOTLY_PAPER,
          plot_bgcolor: PLOTLY_PLOT,
          font: { color: PLOTLY_TEXT, size: 13 },
          ...
          xaxis: {
            ...
            tickfont: { color: PLOTLY_TEXT, size: 13 },
            automargin: true,
            showline: true,
            linecolor: "#a9d6e5",
            mirror: false,
          ...
          yaxis: {
            title: {
              text: featureLabel,
              font: { color: PLOTLY_MUTED, size: 14 },
              standoff: 16,
            },
            tickfont: { color: PLOTLY_TEXT, size: 13 },
          ...
          legend: {
            ...
            bordercolor: "#a9d6e5",
            borderwidth: 1,
            font: { color: PLOTLY_TEXT, size: 12 },
            itemwidth: 22,
            traceorder: "normal",
            itemsizing: "constant",
          },
